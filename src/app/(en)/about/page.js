  ...
  return (
    <div className="about-us-page">
      ...
      <p>
        ...
        tested by the most qualified engineers specialized in these fields.
      </p>

      <iframe
        width="560"
        height="315"
        src="https://www.youtube.com/embed/-MJcAUNPeU4?si=8OFJLl4ynCNR9KIF"
      ...
      <div className="team-section">
        <div className="team-member">
          <img
            ...
            src="/sayed-mahmod.png"
            width={240}
            height={240}
            alt=""
          />
          <p className="team-name">Eng. Sayed Mahmoud</p>
          <p className="team-title">Chairman and CEO</p>
          <p className="team-subtitle">
            Consultant for electricity and renewable energy works
          </p>
        </div>
        <div className="team-member">
          <img
        ...
        <div className="team-member">
          <img
            className="team-image"
            src="/Shimaa-Gamal.jpeg"
            width={240}
            height={240}
            alt=""
          />
          <p className="team-name">Shimaa Gamal</p>
          <p className="team-title"></p>
